...
import { MOCK_CERT_ARN, runConstructTest } from "./test-utils";
import { ReactApp, ReactAppConstructProps } from "./react-app";
...
function runTest(
  ...
  props: (
    ...
    "doNotBuild" | "doNotUpload" | "frontendPath"
  >
) {
    ...
    runTest(
      ...
      (stack) => ({
        ...
        domain: {
          ...
          hostedZone: cdk.aws_route53.HostedZone.fromHostedZoneAttributes(
            stack,
            "hostedZone",
            {
              zoneName: domainName,
